...
public class MainActivity extends AppCompatActivity {
    ...
    private void letsDoSomeNetworking(String url) {
        ...
        client.get(url, new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                ...
                bitcoinPriceModel coinData = bitcoinPriceModel.fromJson(response);
                Log.d("Bitcoin", "Coin Price: "+coinData.getCoinPrice());
                updateUI(coinData);
            }
    ...
    public void updateUI(bitcoinPriceModel coinData){
        mPriceTextView.setText(""+coinData.getCoinPrice());
    }
